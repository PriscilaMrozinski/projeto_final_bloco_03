...
function FormProdutos() {
	...
	return (
		<div className="container flex flex-col items-center justify-center mx-auto px-2 p-20 md:pt-4 md:pb-8">
			<h1 className="text-3xl md:text-4xl text-center my-8  text-teal-700 font-semibold">
				{id !== undefined ? "Editar Produto" : "Cadastrar Produto"}
			</h1>

			<form
				className="w-full max-w-md md:max-w-3/4 flex flex-col gap-4 px-2  text-gray-500 text-2xl"
			...
			>
				<div className="flex flex-col gap-2">
					...
					<input
						...
						name="nome"
						required
						className="border-2 border-gray-400 rounded p-2 bg-white text-base md:text-lg"
					/>
				</div>
				...
				<div className="flex flex-col gap-2">
					...
					<select
						name="categoria"
						id="categoria"
						className="p-2 bg-white border-2 rounded  border-gray-400"
				...
				<button
					className="rounded text-white bg-teal-600 py-2 px-4 hover:bg-white hover:text-teal-600 transition-all duration-300"
					type="submit"
				>
					{isLoading ? (
